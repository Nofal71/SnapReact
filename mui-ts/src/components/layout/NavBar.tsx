...
import { snap_features } from '../../config/snap-react';
...
const NavBar: React.FC = () => {
    ...
    const [scale, setScale] = React.useState<boolean>(true);
        ...
        >
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <MaterialUISwitch sx={{ m: 1 }} size='small' onClick={() => toggleTheme('dark')} defaultChecked={theme_mode === 'dark'} />
