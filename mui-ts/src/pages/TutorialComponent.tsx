          ...
          <Button
            ...
            onClick={() =>
              setConfirm(true, 'Test Confirmation', 'Are you sure you want to continue?', [
                { label: 'Yes', sx: { backgroundColor: 'primary.light' }, variant: 'contained', handler: () => setAlert("Confirmed", 'success') },
                { label: 'No', sx: { backgroundColor: 'primary.light' }, handler: () => setAlert("Cancelled", 'error') },
              ])
            }
            sx={{ mb: 2 }}
          >
