...
const ConfirmComponent: React.FC<ConfirmComponentProps> = ({ data, onSubmit, onClose }) => {
  const [formData, setFormData] = useState<FormData>(data || { name: '', email: '' });
  ...
  return (
    <Box p={5} display={'flex'} gap={4}>
      ...
      <Button
        ...
        variant="contained"
        onClick={() =>
          setConfirm(true, 'Test Dialogue', 'This is Test Confim Dialogue', [
